  ...
  return (
    <div>
        ...
        <h1 className='justify-center text-white text-3xl font-bold  '>Login</h1>
          <label className='mt-5 text-xl text-start text-white mx-[10%] font-bold'>username</label>
          <input className='mt-5 w-[80%] mx-[10%]  px-6 py-4 border-b-2 border-white bg-transparent text-white ' type='text' onChange={hadlechange} name='user' value={user} id="user"  placeholder='Enter Username'/>
          <label className='mt-5 text-xl text-start text-white mx-[10%] font-bold'>Password</label>
          
          <input className='mt-5  px-6 mx-[10%]  py-4 w-[80%] border-b-2 border-white bg-transparent text-white ' type='password' placeholder='Enter Password' onChange={hadlechange} name='password' value={password} id="password" />
